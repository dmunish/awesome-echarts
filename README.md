...
- [notecharts](https://github.com/dmunish/notecharts) @dmunish - ECharts for Jupyter, with native Colab support and extra utilities like palette loading, Google Fonts, and more.
